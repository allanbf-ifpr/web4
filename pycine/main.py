...
# Busca o artista pelo nome passado na URL e retorna o primeiro
@app.get("/artist/name/{name}")
async def get_artista(name):
    artist = RequestApi.get_artista_by_name(name)
    return artist
